...
func createIssue(t *testing.T) {
	...
	assert.Equal(t, (*string)(nil), issue.GetCommentID())
	assert.Equal(t, (*string)(nil), issue.GetCommentKind())
...
func pushCode(t *testing.T) {
	...
	assert.Equal(t, (*string)(nil), pr.GetCommentID())
	assert.Equal(t, (*string)(nil), pr.GetCommentKind())
